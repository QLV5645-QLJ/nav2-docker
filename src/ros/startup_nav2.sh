...
ros2 launch turtlebot3_bringup turtlebot3_state_publisher.launch.py use_sim_time:=True & sleep 5; \
ros2 launch nav2_bringup nav2_bringup_launch.py map:='/opt/ros/dashing/share/turtlebot3_navigation2/map/map.yaml' params:='/opt/ros/dashing/share/turtlebot3_navigation2/param/waffle.yaml'  use_sim_time:='true' 
