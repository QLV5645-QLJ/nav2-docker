...
ros2 launch nav2_bringup my_gazebo_launch.py map:='/opt/ros/dashing/share/turtlebot3_navigation2/map/map.yaml' params:='/opt/ros/dashing/share/turtlebot3_navigation2/param/waffle.yaml'  use_sim_time:='true'
