...
# source /opt/ros/dashing/setup.bash; ros2 launch nav2_bringup my_gazebo_launch.py map:='/opt/ros/dashing/share/turtlebot3_navigation2/map/map.yaml' params:='/opt/ros/dashing/share/turtlebot3_navigation2/param/waffle.yaml'  use_sim_time:='true' & rviz2
...
# xterm  -e "bash; source ~/.bashrc; ros2 run demo_nodes_cpp talker "
# sh -c "ros2 run demo_nodes_cpp talker"
# exec "$@ ros2 run demo_nodes_cpp talsker"
# echo "Executing command: ros2"
# xterm -e 'bash /root/test.sh;'
# xterm -e /bin/bash -l -c 'ros2 run demo_nodes_cpp talker;'
# export TURTLEBOT3_MODEL=waffle; export GAZEBO_MODEL_PATH=:/opt/ros/dashing/share/turtlebot3_gazebo/models ;export GAZEBO_HOSTNAME=localhost;\
# source /opt/ros/dashing/setup.bash;ros2 run demo_nodes_cpp talker & sleep 5 ;ros2 run demo_nodes_cpp listener
